...
>
  ...
  <div class="banner-simple__arrow banner-simple__arrow--prev hidden" data-slider-arrow-left>
    <i class="banner-simple__icon"><svg class="svg-icon svg-icon--angle"><use xlink:href="{$THEME}_img/sprite.svg#svg-icon__angle-left"></use></svg></i>
  </div>
  <div class="banner-simple__arrow banner-simple__arrow--next hidden" data-slider-arrow-right>
    <i class="banner-simple__icon"><svg class="svg-icon svg-icon--angle"><use xlink:href="{$THEME}_img/sprite.svg#svg-icon__angle-right"></use></svg></i>
  </div>
  {/if}
