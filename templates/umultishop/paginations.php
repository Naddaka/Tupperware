...
$paginationConfig['prev_link'] = '<i class="paginator__arrow"><svg class="svg-icon"><use xlink:href="'.$local_theme_url.'_img/sprite.svg#svg-icon__angle-left"></use></svg></i>';
...
$paginationConfig['next_link'] = '<i class="paginator__arrow"><svg class="svg-icon"><use xlink:href="'.$local_theme_url.'_img/sprite.svg#svg-icon__angle-right"></use></svg></i>';
$paginationConfig['next_tag_close'] = '</li>';

/* Last page */
$paginationConfig['last_tag_open'] = '<li class="paginator__item paginator__item--last">';
