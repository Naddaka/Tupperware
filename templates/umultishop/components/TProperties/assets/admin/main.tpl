<div class="clearfix">
    <input type="text" id="prorerties_filter" style="width: 300px;" placeholder="{lang('Start typing property name here','fullMarket')}">
    ...
    <table class="table table-striped table-bordered table-hover table-condensed">
        <thead>
            <tr>
                ...
                <th class="span5">
                    {lang('Name', 'fullMarket')}
                </th>
                <th class="span5">
                    {lang('Type', 'fullMarket')}
                </th>
            </tr>
        </thead>
        <tbody>
