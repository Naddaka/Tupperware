<div class="content__row">
  <div class="typo">
    <p>{tlang('Thank you for shopping at')} {echo $_SERVER['HTTP_HOST']}</p>
    <p>{tlang('Your order details are below')}</p>
  </div>
</div>
<div class="content__row">
          ...
          <div class="order-details__list">
            ...
            <div class="order-details__item">
              {if $item.field_type_id == 3}
                <a class="btn btn-default btn-xs" href="{media_url($item.field_data)}" target="_blank">
                  <svg class="svg-icon svg-icon--in-btn"><use xlink:href="{$THEME}_img/sprite.svg#svg-icon__download"></use></svg>
