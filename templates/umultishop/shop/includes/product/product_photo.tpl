...
>
  ...
  <!-- Main photo -->
  <a class="product-photo__item product-photo__item--lg {if !$model->firstVariant->hasMainImage()}product-photo__item--no-photo{/if}" href="{media_url($model->firstVariant->getLargePhoto())}" target="_blank"
