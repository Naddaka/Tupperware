...
class Wishlist_model extends CI_Model
{
    ...
    public function setSettings($settings) {
        ...
        ModuleSettings::ofModule('wishlist')->set($settings);
    }
    ...
    public function getAllUsers() {
        ...
        return $users ? $users->result_array() : FALSE;
    }
    ...
    public function getUserWishListCount($user_id) {
        $query = $this->db
            ->where('user_id', $user_id)
            ->get('mod_wish_list');
        return $query ? count($query->result_array()) : 0;
    }
    ...
    public function getUserWishListItemsCount($user_id) {
        $query = $this->db
            ...
            ->where('shop_products.active', 1)
            ->join('mod_wish_list_products', 'mod_wish_list_products.wish_list_id=mod_wish_list.id')
            ->join('shop_product_variants', 'mod_wish_list_products.variant_id=shop_product_variants.id')
