    ...
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                ...
                <a class="btn btn-small btn-success" href="/admin/components/run/shop/rbac/privilege_create" ><i class="icon-plus-sign icon-white"></i>{lang('Create privilege','admin')}</a>
            </div>
        </div>
    </div>
                ...
                <table class="table  table-bordered table-hover table-condensed">
                    ...
                    <tbody class="sortable" id="rltbl">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/admin/components/run/shop/rbac/privilege_edit/{echo $item->getId()}">{echo ShopCore::encode($item->getName())}</a>
                            </td>
                            <td>
