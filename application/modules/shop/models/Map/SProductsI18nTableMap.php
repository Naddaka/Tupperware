...
class SProductsI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'shop.models.Map.SProductsI18nTableMap';
     ...
     */
    const CLASS_DEFAULT = 'shop.models.SProductsI18n';
    ...
    public function initialize()
    {
        ...
        $this->addForeignPrimaryKey('id', 'Id', 'INTEGER' , 'shop_product_variants', 'product_id', true, null, null);
