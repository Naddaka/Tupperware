<section class="mini-layout">
    <div class="frame_title clearfix">
        <div class="pull-left">
            ...
            <span class="title">{lang('Create pattern','smart_filter')}</span>
        </div>
        <div class="pull-right">
            <div class="d-i_b">
                ...
                <button type="button" class="btn btn-small btn-success formSubmit" data-form="#seo_form" data-submit>
                    ...
                    <td colspan="6">
                        <div class="inside_padd">
                            <form method="post" id="seo_form"
                                  action="{$BASE_URL}admin/components/cp/smart_filter/create" class="form-horizontal">
                                ...
                                <div class="control-group m-t_10 d_n" data-hidden>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea data-insert-var class="elRTE" id="seo_text"
                                                  name="seo_text">{echo $link['seo_text']}</textarea>
                                    </div>
                                </div>
                                {form_csrf()}
                            </form>
