<div class="d_n">
    ...
    <b data-var>{literal}{{properties|join(',')}}{/literal}</b> - {lang("Array of selected properties",'smart_filter')}<br/>
    <b data-var>{literal}{{brands|join(',')}}{/literal}</b> - {lang("Array of selected brands",'smart_filter')}<br/>
